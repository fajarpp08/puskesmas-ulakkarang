            ...
            <div class="container px-0">
                <nav class="navbar navbar-light navbar-expand-xl">
                    <div class="rounded-circle overflow-hidden">
                        <img src="{{ asset('images/logo-puskesmas.png') }}" class="img-fluid rounded-circle"
                            ...
                            <div class="d-flex">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column ms-2" style="width: 150px;">
                                        <span class="text-body">Fajar Putra Pratama</span>
                                        <small>Sat. 08 jun 2024</small>
                                    </div>
                                </div>
                            </div>
                            {{-- <a href="{{ route('login') }}">
            ...
            <div class="row g-4">
                <div class="col-lg-7 col-xl-8 mt-0">
                    <div class="position-relative overflow-hidden rounded">
                        <img src="{{ asset('images/puskesmas-home.jpg') }}" class="img-fluid rounded img-zoomin w-100"
                            alt="">
                    ...
                    <div class="border-bottom py-3">
                        <a href="#" class="display-4 text-dark mb-0">Selamat datang di <br>Puskesmas Ulak
                            Karang</a>
                    </div>
                    <p class="mt-3 mb-4">Puskesmas Ulak Karang didirikan pada tahun 1975. Pertama kali dipimpin oleh dr.
                        Tamrin dengan 6 orang pegawai yang terdiri dari 1 orang bidan, 1 orang perawat, 1 orang tenaga
                        sanitasi, 1 orang pembantu bidan, 1 orang pembantu perawat dan 1 orang tenaga tata usaha dengan 11 program
                        pokok. Wilayah kerja Puskesmas Ulak Karang setelah pemekaran kota Padang menjadi 11 kecamatan, Alai masuk
                        ke Padang Utara dan 3 buah Pustu di bawah Puskesmas Alai menjadi milik Puskesmas Ulak Karang, sehingga pegawai
                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column">
                                    <a href="#" class="h3">Sejarah didirikan Pusat Kesehatan Masyarakat (Puskesmas)</a>
                            ...
                            <div class="col-12">
                                <div class="rounded overflow-hidden">
                                    <img src="{{ asset('storage/berita/' . $beritaTerbaru->gambar_berita) }}"
                                        class="img-fluid rounded img-zoomin w-100" alt="" style="height: 200px; object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="d-flex flex-column">
                                    <a href="#" class="h4 mb-2">{{ $beritaTerbaru->nama_berita }}</a>
                                    <p class="fs-5 mb-0"><i class="fa fa-calendar"> {{ \Carbon\Carbon::parse($beritaTerbaru->tanggal_berita)->format('d-m-Y') }} </i> </p>
                                    <p class="fs-5 mb-0"><i class="fa fa-clock"> Bacaan {{ $beritaTerbaru->lama_berita }} menit</i></p>
                                </div>
                            </div>
                            {{-- @endforeach --}}
                                    ...
                                    <div class="col-5">
                                        <div class="overflow-hidden rounded">
                                            <img src="{{ asset('storage/berita/' . $berita->gambar_berita) }}"
                                                class="img-zoomin img-fluid rounded w-100" alt="" style="height: 100px; object-fit: cover;">
                                        </div>
                                    </div>
                                    <div class="col-7">
                                        <div class="features-content d-flex flex-column">
                                            <a href="#" class="h6">{{ $berita->nama_berita }}</a>
                                            <small><i class="fa fa-clock"> {{ \Carbon\Carbon::parse($berita->tanggal_berita)->format('d-m-Y') }}</i> </small>
                                            <small><i class="fa fa-eye"> Bacaan {{ $berita->lama_berita }} menit</i></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-light rounded">
                        <div class="rounded-top overflow-hidden">
                            <img src="{{ asset('storage/fasilitas/' . $fasilitas->gambar_fasilitas) }}"
                                class="img-zoomin img-fluid rounded-top w-100" alt="" style="height: 200px; object-fit: cover;">
                        </div>
                        <div class="d-flex flex-column p-4">
                            <a href="#" class="h4">{{ $fasilitas->nama_fasilitas }}</a>
                            <div class="d-flex justify-content-between">
                                <a href="#" class="small text-body link-hover">{{ $fasilitas->deskripsi_fasilitas }}</a>
            ...
            <div class="latest-news-carousel owl-carousel">
                ...
                <div class="latest-news-item">
                    <div class="bg-light rounded">
                        ...
                        <div class="d-flex flex-column p-4">
                            <a href="#" class="h4">{{ $pengumuman->nama_pengumuman }}</a>
                            <div class="d-flex justify-content-between">
                                <a href="#" class="small text-body link-hover">{{ $pengumuman->deskripsi_pengumuman }}</a>
                                {{-- {{ \Carbon\Carbon::parse($berita->tanggal_berita)->format('d-m-Y') }} --}}
                                <small class="text-body d-block"><i class="fas fa-calendar-alt me-1"></i> {{ \Carbon\Carbon::parse($pengumuman->tanggal_pengumuman)->format('d-m-Y')}}</small>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-8">
                                        <div class="position-relative rounded overflow-hidden">
                                            <img src="{{ asset('assets-user/img/news-1.jpg') }}"
                                        ...
                                        <div class="row g-4">
                                            <div class="col-12">
                                                <div class="row g-4 align-items-center">
                                                    <div class="col-5">
                                                        <div class="overflow-hidden rounded">
                                                            <img src="{{ asset('assets-user/img/news-3.jpg') }}"
                                            ...
                                            <div class="col-12">
                                                <div class="row g-4 align-items-center">
                                                    <div class="col-5">
                                                        <div class="overflow-hidden rounded">
                                                            <img src="{{ asset('assets-user/img/news-4.jpg') }}"
                                                                class="img-zoomin img-fluid rounded w-100"
                                                                alt="">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row g-4 align-items-center">
                                                    <div class="col-5">
                                                        <div class="overflow-hidden rounded">
                                                            <img src="{{ asset('assets-user/img/news-5.jpg') }}"
                                                                class="img-zoomin img-fluid rounded w-100"
                                                                alt="">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row g-4 align-items-center">
                                                    <div class="col-5">
                                                        <div class="overflow-hidden rounded">
                                                            <img src="{{ asset('assets-user/img/news-6.jpg') }}"
                                                                class="img-zoomin img-fluid rounded w-100"
                                                                alt="">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row g-4 align-items-center">
                                                    <div class="col-5">
                                                        <div class="overflow-hidden rounded">
                                                            <img src="{{ asset('assets-user/img/news-7.jpg') }}"
                                                                class="img-zoomin img-fluid rounded w-100"
                                                                alt="">
                                                        </div>
                                                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="lifestyle-item rounded">
                                        <img src="{{ asset('assets-user/img/lifestyle-1.jpg') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="lifestyle-item rounded">
                                        <img src="{{ asset('assets-user/img/lifestyle-2.jpg') }}"
                                            class="img-fluid w-100 rounded" alt="">
                                        <div class="lifestyle-content">
                                            <div class="mt-auto">
                                                <a href="#" class="h4 text-white link-hover">There are many
                                    ...
                                    <div class="row g-4">
                                                ...
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('assets-user/img/features-sports-1.jpg') }}"
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center features-item">
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('assets-user/img/features-technology.jpg') }}"
                                                                class="img-zoomin img-fluid rounded-circle w-100"
                                                                alt="">
                                                        </div>
                                                        <span
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center features-item">
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('assets-user/img/features-fashion.jpg') }}"
                                                                class="img-zoomin img-fluid rounded-circle w-100"
                                                                alt="">
                                                        </div>
                                                        <span
                                        ...
                                        <div class="col-12">
                                            <div class="row g-4 align-items-center features-item">
                                                <div class="col-4">
                                                    <div class="rounded-circle position-relative">
                                                        <div class="overflow-hidden rounded-circle">
                                                            <img src="{{ asset('assets-user/img/features-life-style.jpg') }}"
                                                                class="img-zoomin img-fluid rounded-circle w-100"
                                                                alt="">
                                                        </div>
                                                        <span
                                        ...
                                        <div class="col-lg-12">
                                            <div class="position-relative banner-2">
                                                <img src="{{ asset('assets-user/img/banner-2.jpg') }}"
                                                    class="img-fluid w-100 rounded" alt="">
                    ...
                    <div class="footer-item-2">
                            ...
                            <a href="#">
                                <div class="d-flex align-items-center">
                                    <div class="rounded-circle border border-2 border-primary overflow-hidden">
                                        <img src="{{ asset('assets-user/img/footer-1.jpg') }}"
                        ...
                        <div class="d-flex flex-column">
                            <a href="#">
                                <div class="d-flex align-items-center">
                                    <div class="rounded-circle border border-2 border-primary overflow-hidden">
                                        <img src="{{ asset('assets-user/img/footer-2.jpg') }}"
                ...
                <div class="col-lg-6 col-xl-3">
                    <div class="footer-item-4">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-4">
                                <div class="rounded overflow-hidden">
                                    <img src="{{ asset('assets-user/img/footer-3.jpg') }}"
                                        class="img-zoomin img-fluid rounded w-100" alt="">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="rounded overflow-hidden">
                                    <img src="{{ asset('assets-user/img/footer-4.jpg') }}"
                                        class="img-zoomin img-fluid rounded w-100" alt="">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="rounded overflow-hidden">
                                    <img src="{{ asset('assets-user/img/footer-5.jpg') }}"
                                        class="img-zoomin img-fluid rounded w-100" alt="">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="rounded overflow-hidden">
                                    <img src="{{ asset('assets-user/img/footer-6.jpg') }}"
                                        class="img-zoomin img-fluid rounded w-100" alt="">
                                </div>
                            </div>
                        </div>
